...
pub fn trace_stats(data: &PlotData) -> (usize, usize) {
    let groups = [
        ...
        &data.eskf_cmp_att,
        &data.eskf_meas_gyro,
        &data.eskf_meas_accel,
        &data.eskf_bias_gyro,
        &data.eskf_bias_accel,
        &data.eskf_cov_bias,
        &data.eskf_cov_nonbias,
        &data.eskf_mount_sigma,
        &data.eskf_mount_dx,
        ...
        &data.loose_meas_gyro,
        &data.loose_meas_accel,
        &data.loose_bias_gyro,
        &data.loose_bias_accel,
        &data.loose_scale_gyro,
        &data.loose_scale_accel,
        &data.loose_cov_bias,
        &data.loose_cov_nonbias,
        &data.loose_mount_sigma,
        &data.loose_mount_dx,
        &data.loose_nhc_innovation,
        &data.loose_gnss_pos_gate,
        &data.align_cmp_att,
        &data.align_res_vel,
        &data.align_axis_err,
        &data.align_motion,
