...
pub fn trace_stats(data: &PlotData) -> (usize, usize) {
    let groups = [
        ...
        &data.reduced_meas_gyro,
        &data.reduced_meas_accel,
        &data.reduced_bias_gyro,
        &data.reduced_bias_accel,
        &data.reduced_cov_bias,
        &data.reduced_cov_nonbias,
        &data.reduced_mount_sigma,
        &data.reduced_mount_dx,
        &data.reduced_nhc_mount_dx,
        &data.reduced_nhc_innovation,
        &data.reduced_nhc_nis,
        ...
        &data.full_meas_gyro,
        &data.full_meas_accel,
        &data.full_bias_gyro,
        &data.full_bias_accel,
        &data.full_scale_gyro,
        &data.full_scale_accel,
        &data.full_cov_bias,
        &data.full_cov_nonbias,
        &data.full_mount_sigma,
        &data.full_mount_dx,
        &data.full_nhc_innovation,
        &data.full_gnss_pos_gate,
        &data.align_cmp_att,
        &data.align_res_vel,
        &data.align_axis_err,
        &data.align_motion,
