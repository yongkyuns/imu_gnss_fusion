...
pub struct AlignNhcVisualizerConfig {
    pub init_mount_from_final_alg: bool,
    pub init_mount_sigma_deg: Option<f32>,
    pub freeze_mount_from_final_alg: bool,
}
...
pub fn build_plot_data(
    ...
    align_nhc_cfg: AlignNhcVisualizerConfig,
) -> (PlotData, bool) {
    ...
    let align_nhc_data = build_align_nhc_compare_traces(&frames, &timeline, align_nhc_cfg);
