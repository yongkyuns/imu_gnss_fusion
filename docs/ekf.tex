...
\title{EKF Algorithm Formulation}
...
layout this mount is stored in \path{q_bv0..q_bv3}, but its formulation meaning
is \(q_{bv}\):
\begin{equation}
...
\item GNSS position, GNSS velocity, and zero velocity do not directly observe
\(q_{bv}\).
