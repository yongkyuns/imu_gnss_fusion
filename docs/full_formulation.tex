...
\texttt{sensor_fusion/src/full.rs} and \texttt{sensor_fusion/src/generated\_full.rs}. It is used
...
\end{align}
Both quaternions are normalized. Unlike the runtime Reduced implementation, the
full batch update currently does not apply an explicit post-injection reset
