...
def gps_pos_n_observation(P, state, px):
    ...
    cg = CodeGenerator("./generated/gps_pos_n_generated.c")
...
def gps_pos_e_observation(P, state, py):
    ...
    observation = py
    equations = generate_observation_equations(P, state, observation, obs_var)
    cg = CodeGenerator("./generated/gps_pos_e_generated.c")
    write_equations_to_file(equations, cg, 1)
    cg.close()
...
def gps_pos_d_observation(P, state, pz):
    ...
    observation = pz
    equations = generate_observation_equations(P, state, observation, obs_var)
    cg = CodeGenerator("./generated/gps_pos_d_generated.c")
    write_equations_to_file(equations, cg, 1)
    cg.close()
...
def gps_speed_observation(P, state, vx, vy):
    ...
    equations = generate_observation_equations(P, state, observation, obs_var)
    cg = CodeGenerator("./generated/gps_speed_generated.c")
    write_equations_to_file(equations, cg, 1)
    cg.close()
...
def gps_heading_observation(P, state, R_to_earth):
    ...
    equations = generate_observation_equations(P, state, observation, obs_var)
    cg = CodeGenerator("./generated/gps_heading_generated.c")
    write_equations_to_file(equations, cg, 1)
    cg.close()
...
def body_vel_y_observation(P, state, R_to_earth, v):
    ...
    equations = generate_observation_equations(P, state, observation, obs_var)
    cg = CodeGenerator("./generated/body_vel_y_generated.c")
    write_equations_to_file(equations, cg, 1)
    cg.close()
...
def body_vel_z_observation(P, state, R_to_earth, v):
    ...
    equations = generate_observation_equations(P, state, observation, obs_var)
    cg = CodeGenerator("./generated/body_vel_z_generated.c")
    write_equations_to_file(equations, cg, 1)
    cg.close()
...
def gps_vel_n_observation(P, state, vx):
    ...
    observation = vx
    equations = generate_observation_equations(P, state, observation, obs_var)
    cg = CodeGenerator("./generated/gps_vel_n_generated.c")
    write_equations_to_file(equations, cg, 1)
    cg.close()
...
def gps_vel_e_observation(P, state, vy):
    ...
    observation = vy
    equations = generate_observation_equations(P, state, observation, obs_var)
    cg = CodeGenerator("./generated/gps_vel_e_generated.c")
    write_equations_to_file(equations, cg, 1)
    cg.close()
...
def gps_vel_d_observation(P, state, vz):
    ...
    observation = vz
    equations = generate_observation_equations(P, state, observation, obs_var)
    cg = CodeGenerator("./generated/gps_vel_d_generated.c")
    write_equations_to_file(equations, cg, 1)
    cg.close()
...
def generate_code():
    ...
    pred_code_generator = CodeGenerator("./generated/prediction_generated.c")
    ...
    cov_code_generator = CodeGenerator("./generated/covariance_generated.c")
