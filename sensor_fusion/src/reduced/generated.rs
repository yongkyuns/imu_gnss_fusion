...
//! generated by `sensor_fusion/reduced.py` through `sensor_fusion/code_gen.py`. This module provides
...
use crate::reduced::{ReducedImuDelta, ReducedNominalState};
...
pub fn predict_nominal(nominal: &mut ReducedNominalState, imu: ReducedImuDelta) {
...
pub fn predict_nominal_with_gravity(
    nominal: &mut ReducedNominalState,
    imu: ReducedImuDelta,
    gravity_mss: f32,
) {
    let q0 = nominal.q0;
