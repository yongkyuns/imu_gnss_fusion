...
pub struct EskfUpdateDiag {
    ...
    pub sum_dx_att_roll: [f32; ESKF_UPDATE_DIAG_TYPES],
    pub sum_abs_dx_att_roll: [f32; ESKF_UPDATE_DIAG_TYPES],
    ...
    pub sum_dx_vel_n: [f32; ESKF_UPDATE_DIAG_TYPES],
    pub sum_dx_vel_e: [f32; ESKF_UPDATE_DIAG_TYPES],
    pub sum_dx_vel_d: [f32; ESKF_UPDATE_DIAG_TYPES],
    pub sum_abs_dx_vel_n: [f32; ESKF_UPDATE_DIAG_TYPES],
    pub sum_abs_dx_vel_e: [f32; ESKF_UPDATE_DIAG_TYPES],
    pub sum_abs_dx_vel_d: [f32; ESKF_UPDATE_DIAG_TYPES],
    ...
    pub sum_dx_gyro_bias: [[f32; 3]; ESKF_UPDATE_DIAG_TYPES],
    pub sum_abs_dx_gyro_bias: [[f32; 3]; ESKF_UPDATE_DIAG_TYPES],
    pub sum_dx_accel_bias: [[f32; 3]; ESKF_UPDATE_DIAG_TYPES],
    pub sum_abs_dx_accel_bias: [[f32; 3]; ESKF_UPDATE_DIAG_TYPES],
    pub sum_abs_dx_mount_norm: [f32; ESKF_UPDATE_DIAG_TYPES],
    pub sum_dx_mount_roll: [f32; ESKF_UPDATE_DIAG_TYPES],
    pub sum_dx_mount_pitch: [f32; ESKF_UPDATE_DIAG_TYPES],
    pub sum_dx_mount_yaw: [f32; ESKF_UPDATE_DIAG_TYPES],
    pub sum_abs_dx_mount_roll: [f32; ESKF_UPDATE_DIAG_TYPES],
    pub sum_abs_dx_mount_pitch: [f32; ESKF_UPDATE_DIAG_TYPES],
    ...
    pub last_dx_mount_roll_by_type: [f32; ESKF_UPDATE_DIAG_TYPES],
    pub last_dx_mount_pitch_by_type: [f32; ESKF_UPDATE_DIAG_TYPES],
    pub last_dx_mount_yaw_by_type: [f32; ESKF_UPDATE_DIAG_TYPES],
    pub last_k_mount_yaw: f32,
    pub last_innovation: f32,
    pub last_innovation_by_type: [f32; ESKF_UPDATE_DIAG_TYPES],
    pub last_innovation_var: f32,
    pub last_nis: f32,
    pub last_nis_by_type: [f32; ESKF_UPDATE_DIAG_TYPES],
    pub last_h_mount_norm: f32,
    pub last_h_mount_norm_by_type: [f32; ESKF_UPDATE_DIAG_TYPES],
